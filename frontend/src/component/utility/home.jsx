 ...
 */
const OffersGridSection = ({ offers }) => (
  <div className="offers-grid" data-aos="fade-in">
    {offers.map((offer) => (
      <div className="offer-card" key={offer.id}>
        <img className="img" src={offer.image} alt={offer.title} />
        <h3>{offer.title}</h3>
    ...
    <section className="vehicle-categories-section" data-aos="fade-up">
      <div className="container">
        ...
        <div className="category-cards-grid">
          <Link to="/carcard" className="category-card">
            <img src='/images/car.jpg'/> {/* Replace with actual image */}
            <h3>Cars</h3>
            <p>Explore our wide range of passenger cars.</p>
          </Link>
          <Link to="/bikecard" className="category-card">
            <img src='/images/bike.jpg' /> {/* Replace with actual image */}
            <h3>Bikes</h3>
            <p>Discover our collection of motorcycles and scooters.</p>
          </Link>
          {/* Example of integrating the Volkswagen Polo data if you want a specific car link here */}
          {/*
          <Link to={`/car-details/${volkswagenPoloData.id}`} className="category-card">
            <img src={volkswagenPoloData.thumbnail} alt={volkswagenPoloData.title} />
            <h3>{volkswagenPoloData.title}</h3>
            <p>{volkswagenPoloData.description.split('.')[0]}.</p> // Just take the first sentence
          </Link>
          */}
        </div>
      </div>
...
const Home = () => {
  ...
  return (
    <div className="home-container">
      ...
      {/*Luxury vehicle intro */}
      <div className="hand-image-box1" data-aos="fade-in">
        <div className="hand-image-text1">
          <h2>Stay inspired</h2>
          <h4>This is just the beginning. <i className="bi bi-gem"></i> </h4>
        </div>
